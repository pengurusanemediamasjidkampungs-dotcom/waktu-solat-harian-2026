...
(function() {
    ...
    function onNegeriChange(negeriNama) {
        ...
        zonList = zones.map(z => `${z.code} - ${z.name}`);
    ...
    async function loadSettings() {
        try {
            ...
            if (contact && s.contact_url) contact.href = s.contact_url;
            if (donate && s.donate_url) donate.href = s.donate_url;
        } catch (e) { /* fail senyap */ }
    }

    // Buka/tutup panel tetapan
