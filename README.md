...
- Skrin rendah (`max-height: 500px`) — layout landskap kompak
- Skrin sederhana (`501px–700px`) — landskap dengan ruang lebih
- Safe area insets untuk peranti notched (iPhone, etc.)
- Mod standalone PWA — ticker disembunyikan untuk rupa lebih bersih
