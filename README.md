...
Aplikasi ini dibina sebagai **Progressive Web App (PWA)** — boleh dipasang di skrin utama telefon/desktop, berfungsi secara offline, dan menyokong pelbagai orientasi skrin (portrait & landscape). Reka bentuk ikon diinspirasikan dari [skill-icons](https://github.com/tandpfun/skill-icons).
...
| **Kongsi WhatsApp** | Butang terapung (FAB) di sudut kanan bawah — kongsi jadual ke WhatsApp dengan format tebal & condong |
| **Muat Turun Poster JPG** | Butang terapung (FAB) di sudut kiri bawah — hasilkan poster square JPG menggunakan html2canvas |
| **Tema Warna** | 6 pilihan warna latar: Sedia Ada, Beige Coffee, Royal Blue, Turquoise, Gold, Maroon Royal |
...
2. **Buka fail `index.html`** terus di pelayar web (Chrome, Firefox, Edge, Safari).
   ...
   > **Nota:** Tiada keperluan pemasangan lanjut. Tiada npm, tiada build tool, tiada server. Just buka dan guna. Service worker hanya aktif melalui HTTPS (atau localhost).
...
- **Indikator offline** — panel lokasi akan memaparkan ✈️ Mod Luar Talian apabila tiada sambungan
- **Ikon tema gelap** — ikon PWA gaya skill-icons (rounded dark square + bulan sabit & bintang emas)

### Lighthouse Audit
App ini dioptimumkan untuk skor PWA yang tinggi dalam Lighthouse audit.
...
| **Landscape** (mendatar) | Layout flexbox dengan panel bersebelahan, grid kekal 4 lajur, countdown dikecilkan, ticker disembunyikan |
| **Tablet Landskap** | Padding lebih luas, font lebih besar untuk bacaan selesa |
...
- Safe area insets untuk peranti notched (iPhone, etc.) — FAB juga mendapat jarak selamat
- Mod standalone PWA — ticker & theme-picker disembunyikan untuk rupa lebih bersih
...
| **CSS3** | Gaya visual, tema gelap, animasi, responsif, media queries orientasi |
| **[Particles.js](https://cdn.jsdelivr.net/particles.js/2.0.0/particles.min.js)** | Animasi zarah emas latar |
| **[html2canvas](https://html2canvas.hertzen.com/)** | Penghasilan poster JPG square |
