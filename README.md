...
| **Kiraan Masa Menunggu** | Countdown langsung ke waktu solat seterusnya — termasuk ke Imsak esok selepas Isyak |
| **Warna Latar Dinamik** | Latar belakang bertukar mengikut waktu (subuh, siang, asar, malam) |
| **14 Pilihan Tema** | Sedia Ada (dinamik), Beige Coffee, Royal Blue, Gold, Maroon Royal, Purple Royal, Pink Royal, Pearl Putih (teks gelap automatik), Black Immersive, Nardo Grey, Red Royal, Golden Yellow, Rose Pink + popup 256 warna HSL |
| **256 Warna Custom** | Butang swatch + terpopup — pilih dari 256 warna HSL |
...
| **Footer Menu** | 3 pautan dari `settings.json`: Hubungi Developer, Cadangan & Sokongan, Bio Link (Muamalat) |
...
| **Safe Area Insets** | Patuh kepada notched devices (iPhone, dll.) — FAB & box mendapat jarak selamat |
...
> Kod zon hanya dipaparkan di jadual ini — dalam app, hanya nama kawasan ditunjukkan untuk ruang lebih kemas.
...
4. Guna **FAB biru** (kiri bawah) untuk muat turun poster JPG
5. Guna **FAB hijau** (kanan bawah) untuk kongsi ke WhatsApp
6. Pilih **tema warna** dari swatch bulat — atau tekan swatch + pelangi untuk popup 256 warna
7. Footer menu: **Hubungi Developer**, **Cadangan & Sokongan**, **Bio Link (Muamalat)** — pautan diurus melalui `settings.json`
...
├── settings.json           # Pautan footer (hubungi, cadangan, bio)
├── icons/
│   ├── icon-192.png        # Ikon PWA 192x192
│   └── icon-512.png        # Ikon PWA 512x512
├── backup/                 # Backup fail asal
...
- Pautan footer (hubungi, cadangan, bio) boleh diubahsuai melalui fail `settings.json`.
